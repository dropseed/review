...
export function ReviewBreadcrumb({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {/* Repo name */}
      <span className="text-xs text-stone-500">{repoName}</span>

      {/* Comparison segment */}
      <span className="text-stone-600 text-xs">/</span>
      {isPr ? (
        <span
          className="inline-flex items-center gap-1 font-mono text-xs text-violet-400 px-1.5 py-0.5 rounded-md
