      ...
      <div className="flex flex-1 flex-col min-h-0 overflow-hidden">
        <div className="flex items-center gap-2 px-3 py-1.5 border-b border-stone-800/50 bg-stone-900/80 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1 rounded px-1.5 py-0.5 text-xs text-stone-500 hover:text-violet-300 hover:bg-violet-500/10 transition-colors disabled:opacity-50"
            title="Start Guide"
          >
            {guideLoading ? (
              <svg
