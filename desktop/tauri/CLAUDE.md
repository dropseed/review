...
- **File/diff**: `list_files`, `get_file_content`, `get_all_hunks`, `get_files_delta`, `get_diff`, `get_expanded_context`
...
- **Misc**: `search_file_contents`, `write_text_file`, `append_to_file`
