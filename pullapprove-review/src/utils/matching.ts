 ...
 */
export function anyLabelMatchesAnyPattern(labels: string[], patterns: string[]): boolean {
 ...
 */
export function anyLabelMatchesPattern(labels: string[], pattern: string): boolean {
